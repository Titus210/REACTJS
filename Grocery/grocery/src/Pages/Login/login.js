          ...
          <div className="w-full h-3/4 flex flex-col justify-between items-center bg-slate-200 rounded-t-3xl shadow-2xl md:rounded-b-3xl md:w-2/4 lg:w-1/4 md:h-max md:border-0 md:p-2">
            <form action="" className="w-full py-3 relative" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col justify-start items-center w-full">
                <label htmlFor="email" className="ml-4 self-start text-primary-blue text-xl">
                  Enter your email
                </label>
                <input type="text" ref={emailRef} className="border-gray w-11/12 p-2 rounded-lg bg-slate-300" />
                
                <label htmlFor="password" className="ml-4 mt-4 self-start text-primary-blue text-xl">
                  Enter your password
                </label>
