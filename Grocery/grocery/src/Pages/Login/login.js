            ...
            <div className="w-screen">
                <div className="  mx-auto h-screen w-screen  flex flex-col justify items-center  bg-[#214462] lg:flex-row lg:justify-evenly relative">
                    ...
                    <div className=" flex justify-center items-center  w-full h-1/4 top-1 lg:absolute ">
                        ...
                        <p className="text-3xl text-center text-orange-yellow md:text-5xl font-bold">Green<span className='text-primary-green'>Mart</span></p>
                    </div>
                    {/* here */}
                    ...
                    <div className="w-full h-3/4 flex flex-col justify-between items-center  bg-slate-100 rounded-t-3xl shadow-2xl md:rounded-b-3xl md:w-2/4 lg:w-1/4 md:h-1/2 md:border-0 md:p-2">
                        <div className="text-start">
                            <p className='text-center text-2xl font-bold text-orange-yellow '>Welcome Back</p>
                        </div>
                        <div className="flex flex-col justify-start items-center  w-full">
                            <label htmlFor="email" className='ml-4 self-start text-primary-blue text-xl '>Enter your email</label>
                            <input type="text" className='border-gray  w-11/12 py-1 rounded-lg bg-slate-300' />
                            <label htmlFor="password" className='ml-4 mt-4 self-start text-primary-blue text-xl '>Enter your password</label>
                            <input type="text" className='border-gray w-11/12 py-1 rounded-lg bg-slate-300' />
                        </div>
                        <div className="flex flex-row justify-evenly  w-full ">
                            ...
                            <p className='text-primary-blue text-xl underline lg:text-lg'>Forgot password</p>
                        </div>
                        <div className="login-button w-full flex justify-center">
                            <p className='p-2 text-center text-white border bg-orange-yellow  outline-0 rounded-xl w-9/12  hover:bg-black hover:text-orange-yellow md:w-11/12'>Login</p>
                        </div>
                        ...
                        <div className="login-button w-full flex justify-center mb-4 lg:mt-2">
                            <p className='text-xl'>Continue as <span className='text-primary-blue underline'>guest</span></p>
                        </div>
                    </div>
                </div>
            </div>
